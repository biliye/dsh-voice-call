...
`
		...
		function Fab(props) {
			...
			const ttsConfig = (s) => ({ provider: s.ttsProvider, apiKey: s.ttsKey, groupId: s.ttsGroupId, voice: s.ttsVoice, speed: s.ttsSpeed, maxChars: s.ttsMaxChars, baseUrl: s.ttsProvider === 'minimax' ? s.ttsMinimaxBase : s.ttsBase })
