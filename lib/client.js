						...
						tab === 'call' ? e(Fragment, null,
							...
							e('div', { className: 'va-set' },
								...
								settings.ttsProvider === 'openai' ? e(Fragment, null,
									...
									e('input', { className: 'va-input', type: 'password', value: settings.ttsKey, onChange: (ev) => set('ttsKey', ev.target.value), placeholder: settings.ttsProvider === 'mimo' ? 'MiMo API Key' : 'MiniMax API Key' }),
